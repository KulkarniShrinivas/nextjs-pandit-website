    ...
    <div className="terms-container">
      <div className="terms">
        ...
        <p>
          ...
          <ul>
            <li>
              a. Customer Data: Any data, information, or material you provide
              to the Service.
            </li>
            <li>
              b. Effective Date: The earlier of the date this Agreement is
              accepted or when you start using the Service.
            </li>
            <li>
              c. Initial Term: The initial period during which you are obliged
              to use the Service.
            </li>
            <li>
              d. IPR: Intellectual property rights, including patents,
              copyrights, and trademarks.
            </li>
            <li>
              e. License Term(s): The period(s) you are authorised to use the
              service.
            </li>
            <li>
              f. Service: The specific edition of MarathiSarvaPooja accessible
              via a designated website or IP address.
            </li>
            <li>
              g. Unacceptable Content: Any material that may be harmful,
              offensive, or against applicable laws.
            </li>
          </ul>
        </p>
        <p>
          ...
          <ul>
            <li>
              1. This Agreement starts when you create an order or proceed with
              a guest check-out (Effective Date) and lasts until the end of the
              Initial Term. It may automatically renew for a year or less at the
              then-current rate.
            </li>
            <li>
        ...
        <p>
          ...
          <br />
          MarathiSarvaPooja suggests possibilities and does not guarantee the
          accuracy of rituals, rites, or astrological predictions. Different
